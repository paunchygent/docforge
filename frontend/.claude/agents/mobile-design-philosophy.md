...
description: Use this agent when you need Apple-level mobile design systems with meticulous attention to detail. Examples: Creating iOS/Android app designs, building PWAs with native-like feel, designing touch-optimized interfaces with premium micro-interactions.
model: sonnet
---
